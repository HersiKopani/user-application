...
public class AuthenticationSecurityConfig {
    ...
    @Autowired
    AuthenticationJwtAuthFilter authenticationJwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        log.info(LogInfoUtil.GENERIC_MESSAGE+ " -  Start authentication");
        return http.cors(AbstractHttpConfigurer::disable)
                .csrf(AbstractHttpConfigurer::disable) // D
                ...
                .addFilterBefore(authenticationJwtAuthFilter, UsernamePasswordAuthenticationFilter.class).build();
